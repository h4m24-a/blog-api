...
async function refreshToken(req, res) {
  ...
  try {
    // Evaluate the JWT 
    const payload = jwt.verify(refreshToken, JWT_REFRESH_SECRET_KEY);  // Verifying the refresh token to see if its still valid and hasn't been tampered with. If valid, it returns the decoded pauload including user id & claims.
